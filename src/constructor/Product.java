...
//		this.soldOut = false;
	...
	// this 란
	// 	객체 자기자신의 주소값을 갖는 키워드
	// 	this(ㅁㅁ, ㅁㅁ, ㅁㅁ ) <---메소드 : 같은 클래스에서 생성자가 다른 생성자를 실행할때 사용하는 메소드
	//  this() this(int, String, String, int) 메소드를 사용하게 되면 멤버변수에 
	//	값을 대입하는 작업을 매개변수가 가장많은 생성자 메소드에서만 수행하면된다
	}
	...
	public void printProduct() {
		...
		System.out.println("품절여부: " + soldOut);
		System.out.println();
	}
